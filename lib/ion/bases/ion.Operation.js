...
/**
 * Gets a version of the reverse of this operation.
 * 
 * @method
 * @returns {ion.Operation} Inverted copy of this operation
 */
ion.Operation.prototype.invert = function() {
	return new this.constructor(
		this.path.slice( 0 ),
		_.map( this.components, function( cmp ) {
			if ( cmp[0] === 'insert' ) {
				cmp[0] = 'delete';
