...
seq.Operation.prototype.split = function( center, gap ) {
	return [
		new this.constructor( this.start, this.items.slice( 0, center ) ),
		new this.constructor( this.start + gap, this.items.slice( center ) )
	];
};
